...
<html lang="en">
  <head>
    ...
    <!-- Starlight CSS -->
    <link rel="stylesheet" href="/front/css/starlight.css">
  </head>
         ...
         <nav class="nav">
           <div class="dropdown">
             <a href="" class="nav-link nav-link-profile" data-toggle="dropdown">
               ...
               <img src="/front/img/img3.jpg" class="wd-32 rounded-circle" alt="">
             </a>
         ...
         <div class="tab-pane pos-absolute a-0 mg-t-60 active" id="messages" role="tabpanel">
           <div class="media-list">
             ...
             <a href="" class="media-list-link">
               <div class="media">
                 <img src="/front/img/img3.jpg" class="wd-40 rounded-circle" alt="">
             ...
             <a href="" class="media-list-link">
               <div class="media">
                 <img src="/front/img/img4.jpg" class="wd-40 rounded-circle" alt="">
                 <div class="media-body">
             ...
             <a href="" class="media-list-link">
               <div class="media">
                 <img src="/front/img/img7.jpg" class="wd-40 rounded-circle" alt="">
                 <div class="media-body">
             ...
             <a href="" class="media-list-link">
               <div class="media">
                 <img src="/front/img/img5.jpg" class="wd-40 rounded-circle" alt="">
                 <div class="media-body">
           ...
           <div class="media-list">
             ...
             <a href="" class="media-list-link read">
               <div class="media pd-x-20 pd-y-15">
                 <img src="/front/img/img8.jpg" class="wd-40 rounded-circle" alt="">
                 <div class="media-body">
             ...
             <a href="" class="media-list-link read">
               <div class="media pd-x-20 pd-y-15">
                 <img src="/front/img/img9.jpg" class="wd-40 rounded-circle" alt="">
                 <div class="media-body">
             ...
             <a href="" class="media-list-link read">
               <div class="media pd-x-20 pd-y-15">
                 <img src="/front/img/img10.jpg" class="wd-40 rounded-circle" alt="">
                 <div class="media-body">
             ...
             <div class="card widget-messages mg-t-20">
               ...
               <div class="list-group list-group-flush">
                 <a href="" class="list-group-item list-group-item-action media">
                   <img src="/front/img/img10.jpg" alt="">
                   <div class="media-body">
                     <div class="msg-top">
                 ...
                 <a href="" class="list-group-item list-group-item-action media">
                   <img src="/front/img/img9.jpg" alt="">
                   <div class="media-body">
                     <div class="msg-top">
                 ...
                 <a href="" class="list-group-item list-group-item-action media">
                   <img src="/front/img/img8.jpg" alt="">
                   <div class="media-body">
                     <div class="msg-top">
                 ...
                 <a href="" class="list-group-item list-group-item-action media">
                   <img src="/front/img/img7.jpg" alt="">
                   <div class="media-body">
                     <div class="msg-top">
...
@yield("AdminContent")
   ...
   <!-- sl-mainpanel -->
    ...
    <script src="/front/lib/jquery.sparkline.bower/jquery.sparkline.min.js"></script>
    <script src="/front/lib/d3/d3.js"></script>
    <script src="/front/lib/rickshaw/rickshaw.min.js"></script>
    <script src="/front/lib/chart.js/Chart.js"></script>
    <script src="/front/lib/Flot/jquery.flot.js"></script>
    <script src="/front/lib/Flot/jquery.flot.pie.js"></script>
    <script src="/front/lib/Flot/jquery.flot.resize.js"></script>
    <script src="/front/lib/flot-spline/jquery.flot.spline.js"></script>

    <script src="/front/js/starlight.js"></script>
